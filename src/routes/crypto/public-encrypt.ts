...
router.post(
  ...
  async (req: Request, res: Response) => {
    ...
    const cipherText = crypto.publicEncrypt(
      {
        // key: user?.publicKey!,
        key: "-----BEGIN PUBLIC KEY-----\\n-----END PUBLIC KEY-----\n",
